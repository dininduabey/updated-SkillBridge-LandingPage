...
const QualificationsFormPage: React.FC = () => {
  ...
  const [fields, setFields] = useState<FormField[]>([
    ...
    { id: 'certifications', label: 'Certifications', value: '', isCustom: false },
  ...
  const isMultiline = (fieldId: string) => {
    return ['experience', 'education', 'summary', 'projects', 'publications', 'volunteering'].includes(fieldId);
  };
    ...
    <div className="flex flex-col h-screen">
      <div className="flex-1 p-8">
        <div className="max-w-4xl mx-auto h-full">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-foreground mb-2">Professional Profile Form</h1>
            <p className="text-muted-foreground">Fill in your professional details to create your profile</p>
          </div>
